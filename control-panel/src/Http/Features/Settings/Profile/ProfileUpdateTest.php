...
namespace ControlPanel\Http\Features\Settings\Profile;
...
final class ProfileUpdateTest extends TestCase
{
    ...
    public function profile_information_can_be_updated(): void
    {
        ...
        $response
            ...
            ->assertRedirect(route('cp.profile.edit'));
    ...
    public function user_can_delete_their_account(): void
    {
        ...
        $response = $this
            ->actingAs($user)
            ->delete(route('cp.profile.destroy'), [
                'password' => 'password',
            ]);
